...
import {postPedido} from '../../../../services/ventaService';
...
const PedidoForm = () => {
    ...
    const{obtenerPedidos,setModalAgregar}=useContext(PedidosContext);
    ...
    const submit=(e)=>{
        e.preventDefault();
        Swal.fire({
            title:"¿Seguro de crear el Pedido",
            icon:"question",
            ...
            if (rpta.isConfirmed){
                ...
                postPedido({...formulario}).then(data =>{
                    if(data.success){
                        ...
                        obtenerPedidos();
                            ...
                            Swal.fire({
                                title:"Hecho!",
                                text:"EL Pedido a sido creado con exito",
                                icon:"success",
                            ...
                            setModalAgregar(false);
                                ...
                                Swal.fire({
                                  title: "Error!",
                                  text: "No se pudo registrar Pedido",
                                  icon: "error",
                                  showCancelButton: false,
                                  timer: 800,
                                });
